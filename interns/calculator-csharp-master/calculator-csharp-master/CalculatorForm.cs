...
namespace COMP123_S2017_Lesson12B2
{
    public partial class CalculatorForm : Form
    {
        ...
        private void UpDateLatestResult(double change, string operatortype)
        {
            ...
            {
                case "+": 
                    latestResult = change; // what symbol do you add with ? 
                break;
                case "-": 
                    latestResult = change; // what symbol do you subtract with ?  
                break;
                case "x": 
                    latestResult = change;// what symbol do you multiply with ? 
                break;
                case "÷":
                    latestResult = change; // what symbol do you divide with ? 
                break;
                default:
